...
class TestGUI(unittest.TestCase):
    def setUp(self):
        ...
        self.false_event1 = pygame.event.Event(
            pygame.KEYDOWN, {'pos': (0, 0), 'key': 'no_key'})
        self.false_event2 = pygame.event.Event(
            pygame.MOUSEMOTION, {'pos': (0, 0), 'key': 'no_key'})
    ...
    def test_set_lower_part_false_events(self):
        ...
        self.assertEqual(
            self.event_handler.player.minutes['Three of a Kind'], None)
        self.assertEqual(
            self.event_handler.player.minutes['Four of a Kind'], None)
        self.assertEqual(
            self.event_handler.player.minutes['Small Straight'], None)
        self.assertEqual(
            self.event_handler.player.minutes['Large Straight'], None)
    ...
    def test_set_3_of_a_kind(self):
        ...
        self.assertEqual(
            self.event_handler.player.minutes['Three of a Kind'], 9)
    ...
    def test_set_4_of_a_kind(self):
        ...
        self.assertEqual(
            self.event_handler.player.minutes['Four of a Kind'], 20)
    ...
    def test_set_small_straight(self):
        ...
        self.assertEqual(
            self.event_handler.player.minutes['Small Straight'], 15)
    ...
    def test_set_large_straight(self):
        ...
        self.assertEqual(
            self.event_handler.player.minutes['Large Straight'], 20)
