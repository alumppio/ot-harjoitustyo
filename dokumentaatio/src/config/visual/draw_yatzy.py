...
class DrawYatzy:
    def __init__(self, surface, font):
        ...
        self.font = font
        tip_1 = self.font.render('MOUSE1 TO ROLL OR SELECT DICE', True, GRAY, WHITE)
        tip_2 = self.font.render('MOUSE1 TO SET SCORES', True, GRAY, WHITE)
        tip_3 = self.font.render('UNDO SELECTION WITH ESCAPE', True, GRAY, WHITE)
    ...
    def set_upper_part(self, number, dice, player):
        if player.minutes[number] is None:    
            ...
            points = self.font.render(str(player.minutes[number]),True, BLACK, WHITE)
            self.surface.blit(points, pygame.Rect(152,170+(number-1)*25,100,25))
            return True
        else:
            return False
    ...
    def set_pair(self, dice, player):
        if player.minutes["Pair"] is None:
            ...
            points = self.font.render(str(player.minutes["Pair"]),True, BLACK, WHITE)
    ...
    def set_two_pair(self, dice, player):
        if player.minutes["Two Pair"] is None:    
            ...
            points = self.font.render(str(player.minutes["Two Pair"]),True, BLACK, WHITE)
    ...
    def set_3_of_a_kind(self, dice, player):
        if player.minutes["Three of a Kind"] is None:
            ...
            points = self.font.render(str(player.minutes["Three of a Kind"]),True, BLACK, WHITE)
    ...
    def set_4_of_a_kind(self, dice, player):
        if player.minutes["Four of a Kind"] is None:
            ...
            points = self.font.render(str(player.minutes["Four of a Kind"]),True, BLACK, WHITE)
    ...
    def set_small_straight(self, dice, player):
        if player.minutes["Small Straight"] is None:
            ...
            points = self.font.render(str(player.minutes["Small Straight"]),True, BLACK, WHITE)
    ...
    def set_large_straight(self, dice, player):
        if player.minutes["Large Straight"] is None:
            ...
            points = self.font.render(str(player.minutes["Large Straight"]),True, BLACK, WHITE)
    ...
    def set_full_house(self, dice, player):
        if player.minutes["Full House"] is None:
            ...
            points = self.font.render(str(player.minutes["Full House"]),True, BLACK, WHITE)
    ...
    def set_chance(self, dice, player):
        if player.minutes["Chance"] is None:
            ...
            points = self.font.render(str(player.minutes["Chance"]),True, BLACK, WHITE)
    ...
    def set_yatzy(self, dice, player):
        if player.minutes["Yatzy"] is None:    
            ...
            points = self.font.render(str(player.minutes["Yatzy"]),True, BLACK, WHITE)
